...
<script type="text/javascript">
	...
	function loadajax() {
		$.post('/AutomatedStudentRegistrationSystem/Check_Statistics_Servlet',
				function(res) {
					var txt = "";
					console.log(res);
					$.each(res, function(index, value) {
						txt += "<tr><td>" + value.course + "</td><td>"
								+ value.capacity + "</td><td>" + value.vacancy
								+ "</td><td><a href=\"ListOfStudents.jsp?id="
								+ value.cid + "\">" + value.enroll
								+ "</a></td></tr>";
...
body {
	background-image:
		url(/AutomatedStudentRegistrationSystem/images/table1.jpg);
}
